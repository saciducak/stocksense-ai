...
- **LLM Alignment & Fine-Tuning:** Large models require domain adaptation. I included a Parameter-Efficient Fine-Tuning (**PEFT / QLoRA**) pipeline (`finetune_llm.py`) to align the local LLM on specialized financial datasets without incurring massive GPU VRAM costs.
